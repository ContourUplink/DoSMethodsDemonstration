...
namespace DoSMethodsDemonstration
{
    public class SlowLoris4
    {
        ...
        youGotItWrong:
            ...
            SlowlorisAttack4 Slow = new SlowlorisAttack4(target, portStart, threadSleep, true);
    ...
    class SlowlorisAttack4
    {
        ...
        public SlowlorisAttack4(string Host, int Port , int ThreadSleep , bool Loop)
        {
            Website = Host;
            port = Port;
            loop = Loop;
